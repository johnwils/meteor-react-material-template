  ...
  render() {
    ...
    return (
      <div className={classes.layout}>
        ...
        <p>
          The {websiteName} website located at {websiteUrl} is a copyrighted
          work belonging to {companyName}. Certain features of the Site may be
        ...
        <p>
          ...
          websitename uses ‘cookies’. These cookies are used to store
        ...
        <p>
          ...
          the Company should be sent to: companyaddress. After the Notice is
