...
function TermsOfUse({ classes }) {
  ...
  return (
    <div className={classes.layout}>
      ...
      <p>
        The {websiteName} website located at {websiteUrl} is a copyrighted work
        belonging to {companyName}. Certain features of the Site may be subject
      ...
      <p>
        ...
        websitename uses ‘cookies’. These cookies are used to store information
      ...
      <p>
        ...
        Policy for their policies on user data.
      </p>
      ...
      <p>
        ...
        Company should be sent to: companyaddress. After the Notice is received,
        ...
        arbitrator has determined the amount of the award to which either party
        is entitled.
      </p>
      ...
      <p>
        <strong>Copyright/Trademark Information.</strong> &copy; {companyName}{' '}
        {new Date().getFullYear()}. All rights reserved. All trademarks, logos
