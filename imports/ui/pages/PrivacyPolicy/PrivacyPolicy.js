...
function PrivacyPolicy({ classes }) {
  ...
  return (
    <div className={classes.layout}>
      ...
      <p>
        At <span className="website_name">{websiteName}</span>, we collect and
      ...
      <p>
        ...
        information using web beacons (also known as &quot;tracking
        pixels&quot;). Web beacons are electronic images that may be used in our
        services or emails and to track count visits or understand usage and
      ...
      <p>
        ...
        <span>{websiteName}</span> services or to communicate with you about the
